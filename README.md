...
Self-motivated **Machine Learning & AI Engineer** specializing in **FastAPI microservices**, **LLM orchestration** (*LangChain, LlamaIndex*), **feature engineering pipelines**, and **containerized API architectures**. Experienced in building deterministic AI advisory algorithms, RESTful web services, and full-stack enterprise platforms.
...
| :--- | :--- |
| **🧠 AI & Machine Learning** | PyTorch, TensorFlow, Scikit-learn, XGBoost, Keras, OpenCV, Pandas, NumPy, Predictive Analytics, Explainable AI (XAI) |
| **🤖 Generative AI & LLMOps** | LangChain, LlamaIndex, OpenAI API, Anthropic, Gemini, Grok, Agentic Workflows, Chain-of-Thought, ReAct Prompting |
| **⚡ Backend & Web** | Python, C# (ASP.NET Core), JavaScript, TypeScript, FastAPI, Django, Minimal APIs, Streamlit, ReactJS, Tailwind CSS, PHP |
| **☁️ Cloud & MLOps** | Microsoft Azure (Azure ML, Custom Vision), AWS Cloud Foundations, Docker, Docker Compose, CI/CD Pipelines |
| **🗄️ Databases & Vector DBs** | MongoDB Atlas, SQL Server, SQL, Vector DBs (Pinecone, Milvus, Chroma) |
